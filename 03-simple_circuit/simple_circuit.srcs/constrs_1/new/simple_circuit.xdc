...
set_property -dict { PACKAGE_PIN L15   IOSTANDARD LVCMOS33 } [get_ports { d }]; #IO_L22N_T3_AD7N_35 Sch=led4_b
...
set_property -dict { PACKAGE_PIN L19   IOSTANDARD LVCMOS33 } [get_ports { c }]; #IO_L9P_T1_DQS_AD3P_35 Sch=btn[3]
